...
function refreshServer() {
    ...
    paladium_server.init('uranium.yvleis.fr', 25565, function(result) {
...
function initSettingsUserCompteTab() {
    ...
    $("#home-user-compte-displayname-label").html(selectedAcc.displayName);
    $("#home-user-compte-username-label").html(selectedAcc.username);
    $("#home-user-compte-profile").css("background-image", "url('https://mc-heads.net/head/" + selectedAcc.displayName + "')");
}