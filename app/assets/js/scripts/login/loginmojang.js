const loginForm = document.getElementById('login-form-mojang');
const loginUsernameTextField = document.getElementById('login-mail-textfield-mojang');
const loginPasswordTextField = document.getElementById('login-password-textfield-mojang');
const loginButton = document.getElementById('login-button-mojang');
